...

{
 ...
 Out-File -FilePath $scriptPath -InputObject $sb.ToString() -Encoding ASCII -Width 50
...
If(Get-ScheduledTask -TaskName $taskname -EA 0)
  ...
  { Write-Host "Already ther" Unregister-ScheduledTask -TaskName $taskname -Confirm:$false}
